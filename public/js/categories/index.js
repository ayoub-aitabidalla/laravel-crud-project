...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var tableBody = document.querySelector("table.table-hover tbody");
  var apiUrl = "http://localhost:8000/api/categories";
  var updatedCategoryModal = new bootstrap__WEBPACK_IMPORTED_MODULE_3__["Modal"](document.getElementById('updatedCategoryModal'));
  var updatedCategoryNameInput = document.getElementById('updatedCategoryName');
  ...
  addCategoryForm.addEventListener('submit', /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 5:
            _context.prev = 5;
            _context.next = 8;
            return axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(apiUrl, {
              name: categoryName
            });
          case 8:
  ...
  function _fetchCategories() {
    _fetchCategories = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        ...
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 9:
            categories.forEach(function (category) {
              var row = "\n                    <tr id=\"category-row-".concat(category.id, "\">\n                        <td>").concat(category.name, "</td>\n                        <td class=\"text-end\">\n                            <button class=\"icon-btn btn btn-outline-info edit-btn\" data-id=\"").concat(category.id, "\" data-name=\"").concat(category.name, "\">\n                                <i class=\"fas fa-edit\"></i>\n                            </button>\n                            <button class=\"icon-btn btn btn-outline-danger delete-btn\" data-id=\"").concat(category.id, "\">\n                                <i class=\"fas fa-trash\"></i>\n                            </button>\n                        </td>\n                    </tr>\n                ");
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_0___default.a["delete"]("".concat(apiUrl, "/").concat(id));
          case 3:
            response = _context4.sent;
            showToast(response.data.message, "success");
            document.getElementById("category-row-".concat(id)).remove();
            _context4.next = 11;
            break;
          case 8:
            _context4.prev = 8;
  ...
  saveCategoryBtn.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var updatedName, categoryId, response;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          updatedName = updatedCategoryNameInput.value.trim();
          categoryId = saveCategoryBtn.getAttribute("data-id");
          if (updatedName) {
            _context2.next = 5;
            break;
          }
        ...
        case 5:
          _context2.prev = 5;
          _context2.next = 8;
          return axios__WEBPACK_IMPORTED_MODULE_0___default.a.put("".concat(apiUrl, "/").concat(categoryId), {
            name: updatedName
          });
        case 8:
...
/***/ 1:
/*!************************************************!*\
  !*** multi ./resources/js/categories/index.js ***!
  \************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\ayoub\OneDrive\Bureau\test\crud-project\resources\js\categories\index.js */"./resources/js/categories/index.js");
