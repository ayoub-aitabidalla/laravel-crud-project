    ...
    while (1) switch (_context.prev = _context.next) {
      case 0:
        ...
        document.querySelector("#productTable tbody").addEventListener("click", function (e) {
          var _products$rowIndex;
          var deleteButton = e.target.closest("button[data-id]");
          if (deleteButton) {
            e.stopPropagation(); // Prevent row click from triggering
            var _productId = deleteButton.getAttribute("data-id");
            deleteProduct(_productId);
            return;
          }

          // Check if the clicked element is within the first column
          var firstColumn = e.target.closest("td:first-child");
          if (!firstColumn) return;
          var row = e.target.closest("tr"); // Get the clicked row
          if (!row) return;

          // Get the row index and associated product data
          var rowIndex = productTable.row(row).index();
          var productId = (_products$rowIndex = products[rowIndex]) === null || _products$rowIndex === void 0 ? void 0 : _products$rowIndex.id;
          var product = products.find(function (p) {
            return p.id == productId;
          });
          if (product) {
            document.getElementById("updatedProductName").value = product.name;
            document.getElementById("updatedProductDescription").value = product.description;
            document.getElementById("updatedProductPrice").value = product.price;
            document.getElementById("updatedProductCategory").value = product.category.name;
            document.getElementById("updatedProductImagePreview").src = "/storage/".concat(product.image); // Show the current image

            // Show the modal
            var modal = new bootstrap__WEBPACK_IMPORTED_MODULE_3__["Modal"](document.getElementById("updatedProductModal"));
            modal.show();
...
function _fetchProducts() {
  _fetchProducts = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var response;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(apiUrl);
        case 3:
...
function renderProducts(products) {
  ...
  products.forEach(function (product) {
    var deleteButton = "<button class=\"btn btn-outline-danger btn-sm me-1 shadow-sm\" data-id=\"".concat(product.id, "\">\n                                  <i class=\"fas fa-trash\"></i>\n                              </button>");
    var row = productTable.row.add(["<td class=\"d-flex align-items-center\">\n                    <img src=\"/storage/".concat(product.image, "\" \n                         alt=\"").concat(product.name, "\" \n                         class=\"product-image me-3\" \n                         loading=\"lazy\" />\n                    <span class=\"product-name\">").concat(product.name, "</span>\n                </td>"), "<td class=\"text-muted\">".concat(product.description, "</td>"), "<td><span class=\"fw-bold text-success\">$".concat(product.price, "</span></td>"), "<td class=\"text-primary\">".concat(product.category.name, "</td>"), "<td>".concat(deleteButton, "</td>")]).node();

    // Add event listener to the delete button
    $(row).find("button[data-id]").on("click", function () {
...
function _updateProduct() {
  _updateProduct = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(productId, categoryId) {
    var name, description, price, image, formData, response, modalElement, modalInstance, _error$response2;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          name = document.getElementById("updatedProductName").value;
          description = document.getElementById("updatedProductDescription").value;
          price = document.getElementById("updatedProductPrice").value;
          image = document.getElementById("updatedProductImage").files[0];
          ...
          _context3.prev = 10;
          _context3.next = 13;
          return axios__WEBPACK_IMPORTED_MODULE_0___default.a.post("".concat(apiUrl, "/").concat(productId, "?_method=PUT"), formData, {
            headers: {
        ...
        case 13:
          ...
          fetchProducts();
          modalElement = document.getElementById("updatedProductModal");
          modalInstance = bootstrap__WEBPACK_IMPORTED_MODULE_3__["Modal"].getInstance(modalElement);
          modalInstance.hide();
        ...
        case 21:
          ...
          handleError((_error$response2 = _context3.t0.response) === null || _error$response2 === void 0 || (_error$response2 = _error$response2.data) === null || _error$response2 === void 0 ? void 0 : _error$response2.message);
        case 25:
        case "end":
...
function _deleteProduct() {
  _deleteProduct = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(productId) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return axios__WEBPACK_IMPORTED_MODULE_0___default.a["delete"]("".concat(apiUrl, "/").concat(productId));
        case 3:
        ...
        case 8:
          ...
          handleError((_error$response3 = _context4.t0.response) === null || _error$response3 === void 0 || (_error$response3 = _error$response3.data) === null || _error$response3 === void 0 ? void 0 : _error$response3.message);
        case 11:
        case "end":
...
function handleCreateProduct(_x4) {
  return _handleCreateProduct.apply(this, arguments);
}
function _handleCreateProduct() {
  _handleCreateProduct = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(event) {
    var name, description, price, category, image, formData, response, modalElement, modalInstance, _error$response4;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          image = document.getElementById("productImage").files[0]; // Create form data to send to the server
          formData = new FormData();
          formData.append("name", name);
          formData.append("description", description);
          formData.append("price", price);
          ...
          _context5.prev = 12;
          _context5.next = 15;
          return axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(apiUrl, formData, {
            headers: {
              "Content-Type": "multipart/form-data"
            }
          });
        case 15:
          ...
          fetchProducts();
          modalElement = document.getElementById("createProductModal");
          modalInstance = bootstrap__WEBPACK_IMPORTED_MODULE_3__["Modal"].getInstance(modalElement);
          modalInstance.hide();
        ...
        case 32:
          ...
          handleError((_error$response4 = _context5.t0.response) === null || _error$response4 === void 0 || (_error$response4 = _error$response4.data) === null || _error$response4 === void 0 ? void 0 : _error$response4.message);
        case 36:
        case "end":
...
function _fetchCategories() {
  _fetchCategories = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
    var apiUrl, response;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          apiUrl = "http://localhost:8000/api/categories"; // categories API URL
          _context6.prev = 1;
          _context6.next = 4;
          return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(apiUrl);
        case 4:
        ...
        case 8:
          ...
          console.error("Error fetching categories:", _context6.t0);
...
function handleError(error) {
  var _error$response;
  var message = ((_error$response = error.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || "An unexpected error occurred.";
...
module.exports = __webpack_require__(/*! C:\Users\ayoub\OneDrive\Bureau\test\crud-project\resources\js\products\index.js */"./resources/js/products/index.js");
